...
const Tent = () => {
    return (
        <div className='mt-10'>
            ...
            <h2 className='text-center text-3xl font-bold mt-2'>Have A Fun With Our Amazing</h2>
            <h2 className='text-center text-4xl mt-2'>Camping Ground</h2>
            <div className='grid md:grid-cols-4 gap-5 mt-5'>
                <div className="card bg-base-100 shadow-xl">
                    <figure><img src={tent1} alt="Shoes" /></figure>
                ...
                <div className="card bg-base-100 shadow-xl">
                    <figure><img src={tent2} alt="Shoes" /></figure>
                    <div className="card-body">
                ...
                <div className="card bg-base-100 shadow-xl">
                    <figure><img src={tent3} alt="Shoes" /></figure>
                    <div className="card-body">
                ...
                <div className="card bg-base-100 shadow-xl">
                    <figure><img src={tent4} alt="Shoes" /></figure>
                    <div className="card-body">
